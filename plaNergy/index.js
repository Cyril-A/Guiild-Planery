...
app.post('/', urlencodedparser, function(req, res){
	...
	if(userData){
		...
		res.render('dashboard', {signIn: true, name: userData['fullname'], 
			myKey: userData['publicKey'], addressData: addressData});
	}else{
		res.render('home');
	}
});
...
app.post('/signup', urlencodedparser, function(req, res){
	...
	console.log(user.userChain, newUser['fullname']);
	const addressData = cedi.getAddressData(newUser['publicKey']);
	res.render('dashboard', {name: newUser['fullname'], myKey: newUser['privateKey'], addressData: addressData});
});
